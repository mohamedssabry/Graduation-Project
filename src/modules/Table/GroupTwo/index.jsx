      ...
      <table className="w-full border-collapse table-fixed text-sm">
        <thead>
          <tr>
            ...
            {/* Day headers */}
            {["الاحد", "الثلاثاء", "الخميس"].map((day, idx) => (
          ...
          {Array(20)
            ...
            .map((_, idx) => (
              <tr key={idx}>
                ...
                <td className="bg-blue-500 text-white border border-gray-300 text-center">
                  {/* <div className="writing-vertical-rl transform rotate-180 origin-center inline-block">
                    المجموعة (1)
                  </div> */}
                </td>
